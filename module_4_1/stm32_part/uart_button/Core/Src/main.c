...
int main(void)
{
  ...
  // All code below are not reachable
  /* Init scheduler */
  /* USER CODE END 2 */
...
/* USER CODE BEGIN Header_StartUartComunication */
/**
* @brief Function implementing the UartComunicatio thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartUartComunication */
__weak void StartUartComunication(void *argument)
{
  /* USER CODE BEGIN StartUartComunication */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
